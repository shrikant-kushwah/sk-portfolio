        ...
        <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
          ...
          <div>
            ...
            <div className='text-sm py-2 text-[#8892b0]'>
              <p>
              As a fresher, I developed an e-commerce application using React.js, React Hooks, React-Router, JavaScript, HTML5, CSS3, and Bootstrap5. I created key UI components such as Accordions, Filters, Dropdowns, Carousels, Buttons, and Inputs to enhance user experience. I also implemented JWT tokens for secure login and authentication. Additionally, I gained experience with React state management using Redux and Redux Persist, while leveraging React Hooks for handling application lifecycle tasks efficiently.
              </p>
            </div>
          </div>
        </div>
